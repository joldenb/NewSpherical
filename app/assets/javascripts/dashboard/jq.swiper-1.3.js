/*
 * Updated Oct 1, 2012 by Victor Grey to work with jQuery Mobile
 * Licensed under MIT license
 *
 * Based on Swiper 1.3 - Mobile Touch Slider
 * https://github.com/nolimits4web/Swiper
 * which is Copyright 2012, Vladimir Kharlampidi
 *
*/
(function($) {
    var Swiper = function(selector, params, callback) {
    	...
    	//Pagination
    	if (params.createPagination === false) {
    	...
    	_this.init = function() {
    		...
    		wrapperWidth = $slides.length * sliderWidth,
    		wrapperHeight = $slides.length * sliderHeight;
